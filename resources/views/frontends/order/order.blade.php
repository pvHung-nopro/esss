    ...
    <div class="container">
        ...
        <div class="shopper-informations">
            <div class="row">
             ...
             {{-- @include('frontends.order.registration') --}}
             <div class="shopper-info">
                ...
                {{-- <input type = "hidden" name = "_ token" value = "{{Session :: token ()}}"> --}}
                    <input id="name" class="form_two_zz" type="text" value="" placeholder="Tên tài khoản">
                ...
                <a id="checkout" class="btn btn-primary"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">Tiếp tục</font></font></a>
            </div>
                ...
                <div class="col-sm-4">
                    <div class="order-message">
                        ...
                        <label><input type="checkbox"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;"> Vận chuyển đến địa chỉ thanh toán</font></font></label>
                    </div>
                </div>
